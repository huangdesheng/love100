...
//暂停支付信息
export function resPayInfo(params) {
  console.log(params)
  return ax.get(`/helpPay/reHelpPayInfo?planId=${params.planId}&planType=${params.planType}&owedPeriods=${params.owedPeriods}&recipientsId=${params.recipientsId}`)
    .then(res => res.data)
    .catch(e => console.log(e));
}
