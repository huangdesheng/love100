  ...
  <div class="RecipientsInfo">
    ...
    <section class="top_info">
      <aside>
        ...
        <div>
          <van-field v-model="item.age" label="年龄" placeholder="根据身份证识别年龄" readonly />
        </div>
        <div class="grade">
          <span>性别</span>
      ...
      <aside class="IdCard" style="margin:0rem 0;border-bottom:10px solid #f7f7f7">
        <p style="padding:0.45rem;font-size:0.4rem;color:#333">上传受助人身份证照片或者户口本照片</p>
        <div>
          <div>
            <div>
...
import clickStatefrom '../../../utils/moreClick.js';
export default {
  data() {
    return {
      item: {
