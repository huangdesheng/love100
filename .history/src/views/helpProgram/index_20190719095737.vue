              ...
              <div>
                ...
                <div>
                  <p>
                    ...
                    <span
                      v-if="item.helpStatus === -1 || item.helpStatus === 1 || item.helpStatus === 2"
                    ></span>
                    <span v-else-if="item.helpStatus === 1"></span>
                    <span v-else-if="item.helpStatus === 2"></span>
                    <span v-else>
