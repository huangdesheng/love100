          ...
          <div>
            <div style="height:5rem;width:100%;overflow:hidden;">
              <img
                ...
                alt
                width="100%"
                @click="picPreviwe(helpGroupProjectVO.projectPhoto)"
              />
            </div>
          ...
          <div class="concent">
            <ul class="box" id="flexslide">
              ...
              >
                ...
                <div>
                  <img
                    :style="{backgroundImage: 'url(' + item.photo + ')', backgroundSize:'100% 100%',width:'2rem',height:'2rem',backgroundRepeat:'no-repeat'}"
                  />
                </div>
                <span></span>
              </li>
                ...
                <div>
                  ...
                  <div v-if="item.photos[1] !=undefined">
                    <img
                      ...
                      :src="items"
                      alt
                      @click="picPreviwe(item,item.photos[1].urls)"
                    />
                  </div>
                </div>
              </aside>
                ...
                <div>
                  ...
                  <div v-if="item.photos[2] !=undefined">
                    <img
                      ...
                      :key="index"
                      :src="items"
                      @click="picPreviwe(item,item.photos[2].urls)"
                    />
                  </div>
                </div>
              </aside>
