...
<template>
  <!-- <div style="width:100px;height:100px;background:red" class="picImg">
    <p>123</p>
    <div class></div>
  </div>-->
            ...
            >
                ...
                <div>
                  ...
                  <div v-if="item.photos.filter(items=>items.type === 2).length >0" class="morePic">
                    ...
                    <span
                      ...
                      :key="index"
                      class="img"
                      @click="picPreviwe(items,item.photos.filter(items=>items.type === 2)[0].urls)"
              ...
              <aside>
                ...
                <div>
                  ...
                  <div v-if="item.photos.filter(items=>items.type === 3).length>0" class="morePic">
                    <!-- <img
                    ...
                    <span
                      ...
                      :key="index"
                      class="img"
                      @click="picPreviwe(items,item.photos.filter(items=>items.type === 3)[0].urls)"
                      :style="{backgroundImage: 'url(' + items + ')', backgroundSize:'cover'}"
                    ></span>
                  </div>
                </div>
