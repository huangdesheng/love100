...
<template>
  <div style="width:100px;height:100px;background:red">
    <p>123</p>
    <img
      style="background:url(http://192.168.18.253:8888/group1/M00/00/1C/wKgS_V0poX2ATMR9AABhLrQQFGQ776.jpg)"
    />
  </div>
  <!-- <div class="page-program" id="page-program" style="display:none">
