    ...
    <section class="content" id="content">
      <div class="first InstitutionalInfo">
        <div class="infoTop">
          ...
          <div class="IdCard" style="border-top:0;border-bottom:10px solid #f7f7f7">
            <p style="padding:0.6rem 15px;font-size:0.4rem;">机构证明材料</p>
            <div>
              <div>
                <div>
                  <!-- <img alt :style="{backgroundImage: 'url('+item.businessLicense+')'}"> -->
    ...
    async addInstitutional() {
      ...
      if (res.code === 200) {
        this.$dialog
          ...
          .then(() => {
            this.$router.replace({ path: "/helpProgram/groupResets" });
          });
      } else {
        this.$dialog.alert({
          message: res.message
      ...
      if (res.code === 200) {
        this.$dialog
          ...
          .then(() => {
            ...
            let state = this.$route.query.auditStatus;
            this.$router.push({
