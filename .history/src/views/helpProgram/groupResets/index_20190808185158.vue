<template>
  <div>
    <div>
      ...
      <!-- <aside class="tip" v-if="checkStatus ==2">{{infomation}}</aside> -->
      <aside class="tip" v-if="checkStatus == 2">
      ...
      if (res.code === 200) {
        this.$dialog
          ...
          .then(res => {
            ...
            this.step(this.active);
            this.checkStatus == "";
            console.log(this.checkStatus === 2);
          });
      } else {
        this.$dialog.alert({
          message: res.message,
