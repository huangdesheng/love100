            ...
            <div id="morePic">
              <div class="Pic">
                <div v-for="(item,index) in familyPicMore" :key="index">
                  ...
                  />
                  <img :src="item" alt @click="seeBigTu(item,familyPicMore)" />
                </div>
                <!-- </template> -->
              ...
              >
                ...
                <input type="file" multiple @change="tirggerFile" id="file" />
                <div>
                  <van-icon name="photograph" />
                </div>
              </div>
          ...
          <div class="infoTop">
            ...
            <div id="morePic">
              ...
              >
                ...
                <input type="file" multiple @change="studyTirggerFile" id="studyfile" />
                <div>
                  <van-icon name="photograph" />
                </div>
              </div>
  ...
  methods: {
    ...
    async RecipientsInfo(recipientsId) {
      ...
      if (res.code === 200) {
        ...
        this.stydyPicMore = res.data.photos[2].urls;
        this.morePic = res.data.photos[1].urls;
        this.studyPic = res.data.photos[2].urls;
        // this.familyPic = res.data.photos.filter(
        //   item => item.type == 2
        // )[0].urls[0];
        // this.learnPic = res.data.photos.filter(
        //   item => item.type == 3
        // )[0].urls[0];
      } else {
        this.$dialog.alert({
