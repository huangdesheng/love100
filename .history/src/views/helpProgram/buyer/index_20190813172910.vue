...
<template>
  <div class="page-index">
    ...
    <van-cell title="资助金额（元）" :value="radio=='0'?100+'元':info.oneTimePayment+'元'" />

    <div class="continue buyer_content" v-if="continueStatus">
      <div class="stop">
        <h2>教育互助延续</h2>
        <span @click="openTip">
      ...
      WeixinJSBridge.invoke("getBrandWCPayRequest", data, function(res) {
        if (res.err_msg == "get_brand_wcpay_request:ok") {
          _this.$router.replace({
            ...
            query: { type: _this.type, planId: _this.info.planId }
          });
