<template>
  <div>
    <div class="page-assistanceMutal header" id="header" @scroll="handScroll">
  ...
  methods: {
    ...
    async myLaunch() {
      ...
      if (res.code === 200) {
        ...
        console.log(this.myLaunchGroupList);
    ...
    async myLaunchPersonal() {
      ...
      if (res.code === 200) {
        ...
        this.pageNum++;
        this.noDataStatus = false;
        console.log(this.myLaunchPersonList);
      } else if (res.code === 904) {
    ...
    handScroll(e) {
      ...
      console.log(scrolltop, height, currentHeight - 1);
      if (scrolltop + height === currentHeight - 1) {
        if (this.active === 0) {
          this.myLaunch();
    ...
    // 我发起的个人帮扶详情（我的发起）
    async myLaunchPtPer() {
      let res = await service.myLaunchPtPer(30);
      console.log(res);
    },
