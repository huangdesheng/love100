    ...
    <div class="personal_list">
      <header>
        ...
        <div class="header_report">
          <van-notice-bar color="#666" background="#ecf9ff" :left-icon="icon">足协杯战线连续第2年上演广州德比战</van-notice-bar>
          <!-- <van-notice-bar color="#1989fa" background="#ecf9ff" left-icon="info-o">{{mydata.note}}</van-notice-bar> -->
        </div>
      </header>
      <section>
        <div>
