      ...
      <header>
        ...
        <div class="header_report">
          ...
          <van-notice-bar
            ...
            background="#ecf9ff"
            :left-icon="icon"
          >132132123111111111111111111111111111111111111111111111111111111111111111111111111111111111111111</van-notice-bar>
        </div>
      </header>
      <section>
        <div>
...
export default {
  ...
  mounted() {
    ...
    // this.$refs.tes.$refs.content.style.animationDuration = 20 + "s";
    // this.$refs.tes.$refs.content.style.animationDelay = 0 + "s";
  },
...
--------------------- 
版权声明：本文为CSDN博主「岳小哥」的原创文章，遵循CC 4.0 by-sa版权协议，转载请附上原文出处链接及本声明。
原文链接：https://blog.csdn.net/yanby921005/article/details/80283028
  }
};
</script>
