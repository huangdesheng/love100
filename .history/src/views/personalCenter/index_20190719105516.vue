    ...
    <div class="personal_list">
      <header>
        <div class="header_avatar">
          <img v-lazy="item" alt style="width:100%;height:35vh;" />
          <div>
        ...
        <div class="header_report">
          <van-notice-bar color="#666" background="#ecf9ff" :left-icon="icon">
            <span>他们帮了别人一辈子,如今谁来帮助他们</span>
            <span>活着不容易,这是他们一生下来就懂得的道理</span>
          </van-notice-bar>
        </div>
      </header>
      <section>
