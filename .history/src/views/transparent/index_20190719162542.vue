...
<template>
  <div class="page-index">
    ...
    <div class="page-assistanceMutal">
      <van-tabs sticky>
        <van-tab title="公示中">
          <ul class="content" v-if="transparentList.conductList.length != 0">
            <router-link
            ...
            >
              <div class="content-top">
                ...
                <span
                  class="img"
                  :style="{backgroundImage: 'url(' + http://love100.qxiao.net:8888/group1/M00/00/06/rBFAEl0kRAmAXVhfAACVoBydgqQ040.jpg + ')', backgroundSize:'cover'}"
                ></span>
                <div>
                  <div>
                    <span>{{item.name}}</span>
