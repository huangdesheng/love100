    ...
    async moreUploadImg(e, index) {
      ...
      if (resolve.code === 200) {
        ...
        if (index === 3) {
          ...
          let familyItem = []
          familyPicMore.forEach(element => {
            familyItem.push(element.photoUrl)
          });
          this.familyPicMore = familyItem;
          this.item.photos[1].urls = familyItem
        } else if (index === 4) {
          ...
          let studyItem = []
          stydyPicMore.forEach(element => {
            studyItem.push(element.photoUrl)
          });
          this.stydyPicMore = studyItem;
          this.item.photos[2].urls = studyItem
        }
      }
    },
  }
